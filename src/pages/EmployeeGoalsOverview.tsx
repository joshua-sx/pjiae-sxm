...
import EmployeeGoalsTable from '@/components/goals/EmployeeGoalsTable';
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            {isReadOnly 
              ? 'View employee-level goals and their progress' 
              : 'Manage and track employee-level goals and their connections to division goals'}
          </p>
        </div>
            ...
            {filteredGoals.length > 0 ? (
              ...
              <div className="text-center py-10">
                <p className="text-muted-foreground">
                  No employee goals found matching your filters.
                </p>
              </div>
            )}
          </CardContent>
...
export default EmployeeGoalsOverview;

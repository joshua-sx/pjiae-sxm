...
const EmployeeFinalReview = () => {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    toast({
      title: 'Final Self-Assessment submitted',
      description: 'Your year-end review has been submitted successfully.',
      variant: 'success',
    });
  };
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Year-End Self-Assessment</h1>
          <p className="text-muted-foreground mt-2">Complete your final self-assessment for the year</p>
        </div>
        
        <Card>
          <CardHeader>
            <CardTitle>Final Self-Assessment Form</CardTitle>
          </CardHeader>
          <CardContent>
            <Form {...form}>
...
export default EmployeeFinalReview;
